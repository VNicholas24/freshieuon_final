...
import { addDoc, collection, doc, getDoc, getFirestore, setDoc,serverTimestamp, getDocs, updateDoc, deleteDoc, Timestamp  } from "firebase/firestore";
...
export default function AccommodationPage() {
  ...
  const [blog, setBlog] = useState<Blog>({id:"",blogTitle:"",compareImageUrl:""});
