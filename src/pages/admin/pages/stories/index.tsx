...
const Add: FunctionComponent = () => {
    ...
    const handledelete = async (slug: string) => {
        const docRef = doc(getFirestore(), "blogs", slug);
                                        ...
                                        <TableBody>
                                            {filtered.map((article, index) => (
                                                ...
                                                >
                                                    ...
                                                    <StyledBodyCell style={{ width: '40%' }} component="th" scope="row">
                                                        <Link href={`/admin/pages/${article.category}/${article.slug}`} style={{ textDecoration: 'none', color: 'inherit' }}>
                                                            {article.title}
                                                        </Link>
                                                    </StyledBodyCell>
                                                    ...
                                                    <StyledBodyCell style={{ width: '10%' }}><Button style={{ textAlign: 'center' }}><DeleteIcon onClick={() => handledelete(article.slug)}></DeleteIcon></Button></StyledBodyCell>
