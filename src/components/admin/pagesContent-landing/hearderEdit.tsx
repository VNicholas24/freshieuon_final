...
export default function HeaderEdit({headerTitle,headerImageUrl,headerDescription,setBannerTitle,setBannerImageUrl,setBannerDescription,setIsImageUploaded}: HeaderEditProps) {
